...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        ...
        {
          text: "Text for Quote",          href: "sms:4848454829"},
      ]}
      mediaItems={[
        {
  ...
  <div id="services" data-section="services">
      ...
      products={[
        ...
        {
          id: "p4",          name: "Pet Stain & Odor Removal",          price: "Guaranteed",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/carpet-cleaning-technician-working-with--1776259248839-27a49415.png"},
        {
          id: "p5",          name: "Eco-Friendly Deep Cleaning",          price: "Safe & Green",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/close-up-shot-of-professional-sofa-clean-1776259258967-23895b9e.png"},
        {
          id: "p6",          name: "Furniture Restoration",          price: "Revive Beauty",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/carpet-cleaning-technician-working-with--1776259269594-ac6c49db.png"},
      ]}
  ...
  <div id="why-us" data-section="why-us">
      ...
      negativeCard={{
        items: [
          "Deep Bacterial Build-up",          "Unsafe Harsh Chemicals",          "Long Drying Times",          "Ineffective DIY Methods"],
      }}
      positiveCard={{
        items: [
          "Professional Equipment",          "Fast Drying Technology",          "Eco-Friendly Solutions",          "Satisfaction Guaranteed"],
      }}
  ...
  <div id="education" data-section="education">
      ...
      bulletPoints={[
        {
          title: "Improved Air Quality",          description: "Removes allergens trapped in deep fibers."},
        {
          title: "Extended Life",          description: "Prevents abrasive dirt from wearing down fabric."},
        {
          title: "Healthier Environment",          description: "Eliminates bacteria and household odors."},
      ]}
  ...
  <div id="care-tips" data-section="care-tips">
      ...
      faqs={[
        {
          id: "c1",          title: "Vacuuming Frequency",          content: "Vacuum high-traffic areas at least twice weekly to prevent dirt accumulation."},
        {
          id: "c2",          title: "Immediate Spill Response",          content: "Blot spills immediately with a clean, dry cloth—do not rub, as this can force the stain deeper."},
        {
          id: "c3",          title: "Avoid Excess Moisture",          content: "Never use excessive water on furniture, which can cause mildew or backing damage."},
        {
          id: "c4",          title: "Professional Schedule",          content: "Schedule professional cleaning every 6-12 months for homes with kids or pets."},
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "t1",          name: "Sarah J.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/happy-residential-customer-in-a-clean-li-1776259177862-09f8c1dd.png"},
        {
          id: "t2",          name: "Mike R.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/happy-residential-customer-standing-in-c-1776259187608-d52e2dc2.png"},
        {
          id: "t3",          name: "Emily D.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/happy-senior-couple-in-a-well-kept-house-1776259197627-d4a92a32.png"},
        {
          id: "t4",          name: "David L.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/young-family-playing-on-a-clean-rug-1776259209138-22dd6bd1.png"},
        {
          id: "t5",          name: "Jessica M.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CNnjMXXku88iHFue8MKQx5vISJ/happy-homeowner-standing-by-clean-furnit-1776259218340-e8459240.png"},
      ]}
      ...
      columns={[
        {
          title: "Contact Us",          items: [
            {
              label: "Phone: (484) 845-4829",              href: "tel:4848454829"},
            {
              label: "Text: (484) 845-4829",              href: "sms:4848454829"},
            {
              label: "Email: frankfurtsofacleaning@gmail.com",              href: "mailto:frankfurtsofacleaning@gmail.com"},
          ],
        },
        {
